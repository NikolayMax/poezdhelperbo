...
describe('class ApiService (Челябинская область) Ласточка Челябинск-Магнитогорск(7905)', () => {
    ...
    let mockRoutes = [
        'Челябинск', 'Троицк', 'Тамерлан', 'Карталы', 'Магнитогорск'
    ]
...
describe('class ApiService (Челябинская область) Ласточка Челябинск-Екатеринбург', () => {
    ...
    let httpClientService: HttpClientService;
    let mockRoutes = [
        'Челябинск', 'МУСЛЮМОВО', 'НИЖНЯЯ', 'КАМЕНСК-УРАЛЬСКИЙ', 'ОП СОЦГОРОД',
        'ХРАМЦОВСКАЯ', 'АРАМИЛЬ', 'КОЛЬЦОВО', 'ОП Компрессорный завод', 'ШАРТАШ', 'ПЕРВОМАЙСКАЯ',
        'ЕКАТЕРИНБУРГ'
    ]
...
describe('class ApiService (Челябинская область) Ласточка Екатеринбург-Челябинск(7026/7006)', () => {
    ...
    let httpClientService: HttpClientService;
    let mockRoutes = [
        'ЕКАТЕРИНБУРГ', 'ПЕРВОМАЙСКАЯ', 'БОТАНИЧЕСКАЯ', 'ВЕРХНИЙ УФАЛЕЙ',
        'КЫШТЫМ', 'АРГАЯШ', 'ОП 236 КМ', 'ЧЕЛЯБИНСК '
    ]
...
describe('class ApiService (Челябинская область) Ласточка Челябинск - Екатеринбург(7007/7027) отп. 13:42', () => {
    ...
    let httpClientService: HttpClientService;
    let mockRoutes = [
        'ЧЕЛЯБИНСК', 'ОП 236 КМ', 'АРГАЯШ',
        'КЫШТЫМ', 'ВЕРХНИЙ УФАЛЕЙ', 'БОТАНИЧЕСКАЯ', 'ПЕРВОМАЙСКАЯ',
        'ЕКАТЕРИНБУРГ'
    ]
